...
<body>
	...
	<div class="container-fluid" id="panel"
		...
		<div class="span12 offset2">
			<h1 align="center">You can modify selected city here</h1>
		...
		<div class="span12 offset2">
			...
			<h2 align="center" style="font-family: Helvetica Neue">Modify
				City?</h2>
			<s:form action="updateCity" method="post">
					...
					<tbody>
						...
						<tr class="success">
							<td
								style='text-align: center; vertical-align: middle; font-size: 18px'>City
								Name:</td>
							<td><s:textfield name="cityName" label="CITY NAME: " id="myinput"
								placeholder="cityName" theme="simple" cssClass="input-block-level"/></td>
						</tr>

					</tbody>
				</table>
				<br />
				<s:hidden name="cityID" value="%{cityID}"></s:hidden>
				<s:submit name="commandButton" id="mysubmit" value="MODIFY CITY"
