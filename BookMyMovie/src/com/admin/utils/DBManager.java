...
public class DBManager {
	...
	public static void createMovie(Connection con){
		try {
			statement=con.prepareStatement("create table if not exists movie(movieID int auto_increment primary key,movieName varchar(100) not null,storyLine varchar(250) not null,imageURL varchar(250) not null,rating int not null,trailer varchar(250) not null,category varchar(10) not null,cast varchar(250) not null);");
			statement.execute();
		} catch (SQLException e) {
